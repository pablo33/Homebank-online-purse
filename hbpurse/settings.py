"""
Django settings for hbpurse project.
...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware', # After Session and before Common Mideeleware
...
WSGI_APPLICATION = 'hbpurse.wsgi.application'
